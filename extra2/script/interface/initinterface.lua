...
Interface_InitWidgets()
	...
	--Addon:
	gvGUI_WidgetID.Tavern = 				XGUIEng.GetWidgetID( "Tavern" )
	gvGUI_WidgetID.GunsmithWorkshop=  		XGUIEng.GetWidgetID( "GunsmithWorkshop" )
	gvGUI_WidgetID.MasterBuilderWorkshop= 	XGUIEng.GetWidgetID( "MasterBuilderWorkshop" )
	gvGUI_WidgetID.Bridge= 					XGUIEng.GetWidgetID( "Bridge" )	
	gvGUI_WidgetID.TroopMerchant=			XGUIEng.GetWidgetID( "TroopMerchant" )	
	
	gvGUI_WidgetID.TroopMerchantOffers = {}
	gvGUI_WidgetID.TroopMerchantOffers[0] = XGUIEng.GetWidgetID( "TroopMerchantOffersContainer" )	
	gvGUI_WidgetID.TroopMerchantOffers[1] = XGUIEng.GetWidgetID( "BuyTroopOfferContainer1" )
	...
	gvGUI_WidgetID.SelectionHero10 = 		XGUIEng.GetWidgetID( "Selection_Hero10" ) 	
	gvGUI_WidgetID.SelectionHero11 = 		XGUIEng.GetWidgetID( "Selection_Hero11" ) 	
	gvGUI_WidgetID.SelectionHero12 = 		XGUIEng.GetWidgetID( "Selection_Hero12" ) 	
	
	gvGUI_WidgetID.Hero10_LongRangeAura = 		XGUIEng.GetWidgetID( "Hero10_LongRangeAura" ) 	
	gvGUI_WidgetID.Hero10_SniperAttack = 		XGUIEng.GetWidgetID( "Hero10_SniperAttack" ) 	
	gvGUI_WidgetID.Hero11_FireworksMotivate = 	XGUIEng.GetWidgetID( "Hero11_FireworksMotivate" ) 	
	gvGUI_WidgetID.Hero11_FireworksFear = 		XGUIEng.GetWidgetID( "Hero11_FireworksFear" ) 	
	...
	gvGUI_WidgetID.Thief_PlaceKeg= 				XGUIEng.GetWidgetID( "Thief_PlaceExplosives" ) 	
	...
	gvGUI_WidgetID.HeroBGIconContainer = XGUIEng.GetWidgetID( "FindHeroesBGContainer" )
	gvGUI_WidgetID.HeroBGIcon = {}
	gvGUI_WidgetID.HeroBGIcon[1] = 	XGUIEng.GetWidgetID( "Hero1BG" )
	gvGUI_WidgetID.HeroBGIcon[2] = 	XGUIEng.GetWidgetID( "Hero2BG" )
	gvGUI_WidgetID.HeroBGIcon[3] = 	XGUIEng.GetWidgetID( "Hero3BG" )
	gvGUI_WidgetID.HeroBGIcon[4] = 	XGUIEng.GetWidgetID( "Hero4BG" )
	gvGUI_WidgetID.HeroBGIcon[5] = 	XGUIEng.GetWidgetID( "Hero5BG" )	
	gvGUI_WidgetID.HeroBGIcon[6] = 	XGUIEng.GetWidgetID( "Hero6BG" )
	...
	gvGUI_WidgetID.FindRifleLeader = 		XGUIEng.GetWidgetID( "FindRiflemen" )
	gvGUI_WidgetID.FindScout= 				XGUIEng.GetWidgetID( "FindScout" )
	gvGUI_WidgetID.FindThief= 				XGUIEng.GetWidgetID( "FindThief" )
	...
	gvGUI_StateID.DisarmKegCommand =				GUI.GetStateNameByID( "DisarmKegCommand" )
	gvGUI_StateID.StealGoodsCommand =				GUI.GetStateNameByID( "StealGoodsCommand" )
	gvGUI_StateID.SecureStolenGoodsCommand = 		        GUI.GetStateNameByID( "SecureStolenGoodsCommand" )
	gvGUI_StateID.PlaceKegCommand = 		                GUI.GetStateNameByID( "PlaceKegCommand" )
	gvGUI_StateID.ScoutBinocularsCommand = 		        GUI.GetStateNameByID( "ScoutBinocularsCommand" )
	gvGUI_StateID.PlaceTorchCommand = 		                GUI.GetStateNameByID( "PlaceTorch" )
	gvGUI_StateID.ShurikenCommand = 		                GUI.GetStateNameByID( "ShurikenCommand" )
	gvGUI_StateID.SnipeCommand = 		                        GUI.GetStateNameByID( "SnipeCommand" )
	
	
	--reactivate Quest stuff
	if GUIQuestTools ~= nil then
		--reactivate Stopwatch
		if  GUIQuestTools.StopWatchSecondsLeft  ~= nil and GUIQuestTools.StopWatchSecondsLeft > 0 then
			XGUIEng.ShowWidget("MapProgressStuff",1)
			XGUIEng.ShowWidget("StopWatch",1)
		end
		--reactivate QuestInformation
		if GUIQuestTools.QuestInformationFlag ~= nil and GUIQuestTools.QuestInformationFlag == 1 then
...
HintTable[UpgradeCategories.Scout] 				= "UNIT_Scout"
HintTable[UpgradeCategories.Thief] 				= "UNIT_Thief"

HintTable[UpgradeCategories.Tavern] 			= "BUILDING_Tavern"
HintTable[UpgradeCategories.GunsmithWorkshop] 		= "BUILDING_GunsmithWorkshop"
HintTable[UpgradeCategories.MasterBuilderWorkshop] 	= "BUILDING_MasterBuilderWorkshop"
